...
<head>
    ...
    if (!(isset($_SESSION['id']) && $_SESSION['id'] != '')) {
        echo '<script>alert("Please Login first to check your Dashboard."); location.replace("index.php");</script>';
    }
    ?>
    <title>Dashboard | <?php echo "" . $_SESSION['first_name'] . " " . $_SESSION['last_name'] . ""; ?></title>
</head>
...
<body style="background-color: rgb(00, 00, 20);">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="dashboard.php" data-toggle="tooltip" data-placement="bottom" title="View Dashboard">Dashboard</a>
                    </li>
                    <li class="nav-item">
    ...
    <!-- Condition for User Action -->
    <div class="container" align="center">
        <table id="table" border="2" align="center" cellpadding="5" cellspacing="5">
            <tr>
                <td>
                    <h3 align="center" style="color: white;">Select any one operation from below :</h3>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="boxArrange m-4" align="center" id="boxArrange">
                        <div class="box1">
                            <button class="btn btn-outline-light btn-lg m-2 p-4" type="button" id="box1" data-bs-toggle="modal" data-bs-target="#BookNewSlot" data-role="button" data-inline="true" data-toggle="tooltip" data-placement="bottom" title="Book New Parking Slot">
                                <h3><i class="fa fa-plus-circle"></i> Book New Slot</h3></a>
                                <button class="btn btn-outline-light btn-lg m-2 p-4" type="button" id="box2" data-bs-toggle="modal" data-bs-target="#CheckSlotDetails" data-role="button" data-inline="true" data-toggle="tooltip" data-placement="bottom" title="Check your Parking Slot Details">
                                    <h3><i class="fa fa-bars"></i> Check Slot Details</h3></a>
                        </div>
                    </div>
                </td>
            </tr>
                    ...
                    if ($result->num_rows > 0)
                    {
                        ...
                        <div class="container" id="Table" style="width: 90%;>
                            <div class="table" style="overflow-x:auto;">
                                <table class="table table-bordered" id="table" border="2" align="center" style="margin: 25px; color: white;" cellpadding="5" cellspacing="5">
                                    <tr align="center">
                        ...
                        while ($row = $result->fetch_assoc())
                        {
                            ...
                            echo '</td>';
                            echo '<td align="center">';
                            echo $row["vehicle_company"];
                            echo '</td>';
                            echo '<td align="center">';
                            echo $row["vehicle_model_name"];
                            echo '</td>';
                            echo '<td align="center">';
                            echo $row["vehicle_color"];
                            echo '</td>';
                            echo '<td align="center">';
                            echo $row["vehicle_number"];
                            echo '</td>';
                            echo '<td align="center">';
                            echo $row["vehicle_model_year"];
                            echo '</td>';
                            echo '<td align="center">';
                            echo $row["state"];
                            echo '</td>';
                            ...
                            echo '</td>';
                            echo '<td align="center">';
                            echo $row["parking_base"];
                            echo '</td>';
                            echo '<td align="center">';
                            echo $row["book_date"];
                            echo '</td>';
                            echo '<td align="center">';
                            echo $row["book_time_from"];
                            echo '</td>';
                            echo '<td align="center">';
                            echo $row["book_time_till"];
                            echo '</td>';
                            echo '<td align="center">';
                            echo $row["reservation_for_timeperiod"];
                            echo '</td>';
                            echo '<td align="center">';
                            echo $row["remarks"];
                            echo '</td>';
                            echo '<td align="center">';
                            echo '<div class="action d-flex">'; ?>
                            <button type="button" class="btn btn-success" style="width: 55px; padding: 0; margin-top: 0px; margin-bottom: 0px; margin: 5px;"><i class="fa fa-edit"></i> Edit</button>
                            <button type="button" class="btn btn-danger" style="width: 55px; padding: 0; margin-top: 0px; margin-bottom: 0px; margin: 5px;" onClick="location.href='DeleteData.php?reg_id=<?php echo $row['reg_id']; ?>'"><i class="fa fa-trash"></i> Delete</button>
                    <?php echo '</div>';
                            echo '</td>';
                            echo '</tr>';
                        }
                        ...
                        echo '<center><a href="dashboard.php">Click here to Book new Parking Slot</a></center>';
                    }
                    ?>
                    </table>
                </div>
